...
echo ""
echo "Then run:"
echo "docker exec $CONTAINER_ID java -jar /var/jenkins_home/war/WEB-INF/jenkins-cli.jar -s http://localhost:8080 -auth admin:admin123 create-job abc-retail-pipeline < /tmp/pipeline-config.xml"
echo ""
echo "📊 Pipeline will be available at: $JENKINS_URL/job/abc-retail-pipeline/" 