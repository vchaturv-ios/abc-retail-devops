...
echo "🐳 Building and Pushing Docker Image (Free Tier)"
echo "================================================"
echo ""
...
DOCKERHUB_USERNAME=$(grep -o 'vchaturvdocker' k8s/deployment.yaml | head -1)
...
if [ $? -eq 0 ]; then
    ...
    echo ""
    echo "📝 Next step: Run ./deploy-app-free.sh"
else
